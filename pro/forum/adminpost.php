        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>forum</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="http://localhost/forum/adminpost.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Postes</a>
                        <a href="http://localhost/forum/admincomments.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Comments</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <form method="POST" action="../forum/admindelete.php">
                        ...
                        <td>
                            <div class="form-group">
                                <a href="../forum/adminmodify.php?id=<?PHP echo $post['id']; ?>">
