        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="http://localhost/forum/adminpost.php" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Postes</a>
                        <a href="http://localhost/forum/admincomments.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Comments</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <form method="POST" action="deleteCadmin.php">
