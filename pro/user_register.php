...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() >0){
      ...
      if($pass != $cpass){
         ...
         $insert_user = $conn->prepare("INSERT INTO `users`(name, email, password,recovery) VALUES(?,?,?,?)");
         $insert_user->execute([$name, $email, $cpass,$fname]);
         $message[] = 'register successeded!';
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" id ="confirm_password" name="cpass" required placeholder="confirm your password" minlength="8"  class="box">
      <p>*Recovery sentence (a string should be remember it when you forgot your password like nickname,combination of numbers or chars,...)</p>
